...
<div align="center">A highly scalable, offline-first foundation with the best DX and a focus on performance and best practices, testing</div>
...
4.  Run `docker build -t react-boiler-plate .` to create the image if you are cloning it for the first time or if you have made changes in the image<br />
    _At this point you can run `npm start` to see the example app at `http://localhost:3000`._
5.  Run `docker container run -p 80:3000 -v "$(pwd)"/:/app/ react-boiler-plate` to start the container.
6.  Open `http://localhost` to see the site.
