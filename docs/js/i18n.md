...
The complete `react-intl` docs can be found [here](https://github.com/formatjs/react-intl/tree/master/docs).
...
This is set in `react-intl`'s `defineMessages` function which is then exported for use in the component. You can read more about `defineMessages` [here](https://github.com/formatjs/react-intl/blob/master/docs/API.md#definemessages).
