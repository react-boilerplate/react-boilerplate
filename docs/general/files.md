...
- `.github/workflows/*`: Continuous Integration configuration<br/>
- `.github/ISSUE_TEMPLATE`: Template for github Issues<br/>
- `.github/PULL_REQUEST_TEMPLATE`: Template for github pull requests<br/>
