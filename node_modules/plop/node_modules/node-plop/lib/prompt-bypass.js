...
exports.default = function (prompts, bypassArr, plop) {
	...
	const inqPrompts = plop.inquirer.prompt.prompts;
	...
	{ when: data => (Object.assign(data, answers), false) }].concat(_toConsumableArray(prompts.filter(p => !bypassedPrompts.includes(p))));
...
const typeBypass = {
	...
	checkbox: function checkbox(v, prompt) {
