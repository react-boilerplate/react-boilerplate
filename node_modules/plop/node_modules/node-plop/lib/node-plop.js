...
function nodePlop() {
	...
	const plopfileApi = {
		...
		setPrompt: setPrompt,
		setWelcomeMessage: setWelcomeMessage, getWelcomeMessage: getWelcomeMessage,
		setGenerator: setGenerator, getGenerator: getGenerator, getGeneratorList: getGeneratorList,
		setPartial: setPartial, getPartial: getPartial, getPartialList: getPartialList,
		setHelper: setHelper, getHelper: getHelper, getHelperList: getHelperList,
		setActionType: setActionType, getActionType: getActionType, getActionTypeList: getActionTypeList,

		// path context methods
		setPlopfilePath: setPlopfilePath, getPlopfilePath: getPlopfilePath,
		getDestBasePath: getDestBasePath,

		// plop.load functionality
		load: load, setDefaultInclude: setDefaultInclude, getDefaultInclude: getDefaultInclude,
	...
	const runner = (0, _generatorRunner2.default)(plopfileApi, { force: force });
	const nodePlopApi = Object.assign({}, plopfileApi, {
		getGenerator: function getGenerator(name) {
			...
			return Object.assign({}, generator, {
				...
				runPrompts: function runPrompts() {
					let bypassArr = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
					return runner.runGeneratorPrompts(generator, bypassArr);
				}
			});
		},
