...
function _load_get_snapshot_status() {
  return (_get_snapshot_status = _interopRequireDefault(
...
class DefaultReporter extends (_base_reporter || _load_base_reporter())
  .default {
  ...
  printTestFileFailureMessage(testPath, config, result) {
    ...
    const snapshotStatuses = (0,
    (_get_snapshot_status || _load_get_snapshot_status()).default)(
      result.snapshot,
      didUpdate
    );
